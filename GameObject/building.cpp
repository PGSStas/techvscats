...
Building::Building(int id, int settle_cost, AuricField aura) :
    GameObject({45, 45}), auric_field_(aura), id_(id), cost_(settle_cost) {
  auric_field_.SetCarrierCoordinate(&position_);
}

Building::Building(const Building& other) :
    Building(other.id_, other.cost_, other.auric_field_) {
